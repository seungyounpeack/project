...
<form id="detailForm">
	...
	<input type="hidden" id="bsctSe" name="bsctSe" value="${bsctSe}">
			...
			<div class="search_wrap">
				<ul>
				<li>
				<span class="sch_title">게시판</span>
						<select name="board_option" id="board_option" class="select_sch">
							<option value="OFA">공지사항 관리</option>
							<option value="DTR">자료실관리</option>
							<option value="GLLY">데이터 갤러리 관리</option>
							<option value="ANLS">빅데이터 분석사례 관리</option>
							<option value="PWWK">경진대회 수상작 관리</option>
						</select>
				</li>
					<li>
			...
			<div class="paging" id="paging">
				...
				<div class="btn_area">
					<a href="#" class="bt_md b_blue" id="noticeIns">등록</a>
					<a href="#" class="bt_md btn_red" id="noticeDel">삭제</a>
				</div>
		</div>
	</section>
	
	<script src="${pageContext.request.contextPath}/pageJs/manager/noticeMng/noticeMng.js"></script>