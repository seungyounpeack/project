...
<form id="detailForm">
<input type="text" id="noticePk" name="noticePk" value="${noticePk}">
<input type="hidden" id="filePk" name="filePk" value="">
<input type="text" id="bsctSe" name="bsctSe" value="${bsctSe}">
</form>
			<h2>공지사항 수정</h2>
			<div class ="contents">
		 	<!-- 테이블 배치 -->
		 	<div class="board_area">
											...
											<td colspan="3">
												 <div id="fileDiv">
													...
													<button id="btnFile" type="button">
														 ...
														 -->
													<!-- <input id="postFile" class="wd50" name="postFile" type="file" accept="*"> -->
				...
				<div class="btn_area">
					<a href="#" class="bt_md b_blue" id="noticeSave">완료</a>
					<a href="#" class="bt_md b_gray" id="noticeList">취소</a>
				</div>
		</div>
	</section>
	
	<script src="${pageContext.request.contextPath}/pageJs/manager/noticeMng/updateNotice.js"></script>