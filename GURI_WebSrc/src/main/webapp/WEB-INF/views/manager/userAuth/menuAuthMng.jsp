...
%>	
		...
		<section id="container">
			...
			<div class="admin_content">
				<div class="left_area">
					<h3>권한 목록</h3>
					<div data-ax5grid="auth-grid" data-ax5grid-config='{name:"auth-grid"}' class="grid">
					</div>
						<!-- <p class="admin_btns">
				...
				<div class="right_area">
					...
					<div data-ax5grid="menu-grid" data-ax5grid-config='{name:"menu-grid"}' class="grid">
						...
						<p class="admin_btns">
							...
							&nbsp;  -->
							<button id="btnSaveMenuAuth" class="bt_md btn_red" disabled="disabled">저장</button>
							<!-- &nbsp; 
					...
					<div id="formSubCodeInfo" class="tab_content on">
						<table class="admin_write" summary="하위 코드 정보 내용 입력"> 
							...
							<tbody>
								<tr>
									<th>상위 코드명</th>
									<td><input type="text" id="upperCode" class="input_basic" disabled="disabled"/></td>
								</tr>
								<tr>
									<th>코드 ID</th>
...
<!-- Page 스크립트 -->
	<script src="${pageContext.request.contextPath}/pageJs/manager/userAuth/menuAuthMng.js"></script>
