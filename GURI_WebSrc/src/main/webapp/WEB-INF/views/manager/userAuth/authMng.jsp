...
%>
			...
			<div class="admin_content">
				<div class="left_area">
					...
					<div data-ax5grid="role-grid" data-ax5grid-config='{name:"role-grid"}' class="grid">
						...
						<p class="admin_btns"><a id="btnCreateRole" href="#" class="bt_md b_blue">권한 생성</a></p>
				</div>
				<div class="right_area">
					...
					<div class="tab_area">
						<ul class="tab_all">
							...
							<li class="tab_link"  data-tab="tab-2">메뉴 목록</li>
						</ul>
					</div>
					...
					<div id="tab-2" class="tab_content">
						<div data-ax5grid="menu-grid" data-ax5grid-config='{name:"menu-grid"}' class="grid">
							...
							<p class="admin_btns"><a href="#" id="btnSaveRoleMenu" class="bt_md b_blue">저장</a></p>
					</div>
   ...
   <%--  <section class="content-header">
	...
	<!-- Page 스크립트 -->
	<script src="${pageContext.request.contextPath}/pageJs/manager/userAuth/authMng.js"></script>
