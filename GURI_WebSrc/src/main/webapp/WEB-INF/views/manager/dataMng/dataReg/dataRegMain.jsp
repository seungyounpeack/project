...
%>
	...
	<section id="container">
			...
			<div class="admin_content">
				...
				<div class="right_area">
					...
					<div id="tab-1" class="tab_content on">
						...
						<!-- 
						<input type='text' id="codeId" value=""	/>
						<input type='text' id="atchFileId" value=""	/>
						 -->
						<table class="admin_view" summary="데이터 정보 내용 입력">
							...
							<tbody>
								...
								<tr>
									<th>부서</th>
									<td><select name="dpetName" id="dpetName" title="부서" class="custom-select" disabled></select></td>
								</tr>
								<tr>
									<th>테이블명</th>
								...
								<tr>
									...
									<td>
										<div style="position: relative">
											<input type="text" id="targetMonth" class="form-ontrol dateSelect"  value="" disabled/>
										</div>
									</td>
								</tr>
								<tr>
									<th>업로드 파일</th>
									<td><input type="file" id="uploadFiles" name="uploadFiles" class="input_basic" disabled/></td>
								</tr>
								<!-- 
									<tr>
										<th>첨부 파일</th>
								...
								<tr>
									<th>파일 양식 다운로드</th>
									<td>
										<a href="#" id="btnBasFile" class="bt_md b_green" >파일 양식 다운로드</a>
									</td>
								</tr>
							</tbody>
						</table>
						<p class="admin_btns">
							<!-- 파일 다운로드 부분 일단 보류  -->
							<!-- <a href="#" id="btnDldFile" class="bt_md b_green" >파일 다운로드</a> -->
			...
			<div class="admin_content">
				<div id ="content" style='margin-bottom : 8px;'>
					</div>
					<div id ="data-content-rad" style='margin-bottom : 20px; '>
						<input type="radio" name="list" value="year" style='margin-left : 10px'> 대상년도 
						<input type="radio" name="list" value="yearMonth" style='margin-left : 30px'> 대상년월 
						<select name="year" id="year" title="년도" class="custom-select"></select>
						<span style='position: relative'>
							<input type="text" id="yearMonth" class="form-ontrol dateSelect" value="" style='text-align: center'/>
						</span>
						<span class="admin_btns">
							<a href="#" id="btnSearch" class="bt_xs b_blue" >검색</a>
						</span>
						<span id="excel"class="admin_btns">
						</span>
						<span id="data_count">
						</span>
					</div>
					<div data-ax5grid="upload-data-list-grid" data-ax5grid-config='{name:"upload-data-list-grid"}' class="grid">
					</div>
			</div>
...
<%-- 
	...
	<!-- Page 스크립트 -->
	<script src="${pageContext.request.contextPath}/pageJs/manager/dataMng/dataReg/dataRegMain2.js"></script>
