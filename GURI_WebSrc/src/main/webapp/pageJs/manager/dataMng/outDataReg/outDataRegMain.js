...
$(function () {
    ...
    ****************************************************************************************************/
	...
	function fn_getUploadDataList() {
		...
		var requestUrl = "/mamager/dataMng/outDataReg/getOutDataList.do";
	...
	function fn_getUploadHistoryList(paramInfo) {
		...
		var requestUrl = "/mamager/dataMng/outDataReg/getOutDataHisList.do";
		...
		currForm.validate(validationItems, function(returnValidData, validSuccess){
			...
			if(validSuccess){
					...
					setTimeout(function(){
						...
						// Ajax 방식으로 파일 업로드
						Util.requestFileUplaod("/mamager/dataMng/outDataReg/createUploadData.do", formData, function(result){
