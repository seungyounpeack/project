...
(function( $ ) {
    ...
    $.colorPick.prototype = {
        ...
        show: function(element, left, top) {
            ...
            $(element).prepend('<div class="colorPickWrapper"><div id="colorPick" style="display:none;bottom: -' + top * 2 + 'px;left:' + left + 'px"><span>'+$.fn.colorPick.defaults.paletteLabel+'</span></div></div>');
