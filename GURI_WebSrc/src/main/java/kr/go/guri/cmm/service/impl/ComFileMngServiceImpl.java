...
import kr.go.guri.cmm.service.ComFileMngService;
 ...
 *
 */
@Service("ComFileMngService")
public class ComFileMngServiceImpl extends EgovAbstractServiceImpl implements ComFileMngService {
	 ...
	 */
	public String insertFileInf(kr.go.guri.cmm.vo.FileVO fvo) throws IOException, SQLException {
