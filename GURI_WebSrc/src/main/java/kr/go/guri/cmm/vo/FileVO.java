...
public class FileVO implements Serializable {
    ...
    public String getBsctSe() {
		return bsctSe;
	}

	public void setBsctSe(String bsctSe) {
		this.bsctSe = bsctSe;
	}

	public int getBsctSn() {
		return bsctSn;
	}

	public void setBsctSn(int bsctSn) {
		this.bsctSn = bsctSn;
	}
